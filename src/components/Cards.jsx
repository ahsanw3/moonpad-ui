  ...
  return (
    <div className="py-10 px-2 flex w-full">
      <div className=" text-white font-lora block ring-0 p-1 ring-white ring-offset-2 ring-offset-transparent sm:w-[70%] rounded backdrop-blur-[80px]">
        ...
        <p className="ml-2 text-xs">$ARN</p>
        ...
        <button
          type="button"
          className="text-green-400 font-semibold text-xs bg-green-900 mt-2 rounded ml-2 p-1"
        >
          REGISTER
        </button>
        <p className="ml-2 text-xs py-2">
          {" "}
          Arenum is the evolution of mobile gaming and crypto which has
          feure-rich
        </p>
        <div className="flex">
          <p className="text-white font-semibold text-xs ml-2"> Starts:</p>
          <p className="text-sky-700 font-semibold text-xs ml-2">
            {" "}
            Jan 17, 11.00 UTC
          </p>
        </div>
        <div className="flex mt-2">
          <p className="text-white font-semibold text-xs ml-2"> Price:</p>
          <p className="text-sky-700 font-semibold text-xs ml-2">
            {" "}
            !ARN 0.375 $USD
          </p>
        ...
        <div className="flex mt-2 justify-between">
          <p className="text-white font-semibold text-xs ml-2"> Total Raise:</p>
          <p className="text-sky-700 font-semibold text-xs mr-2"> $200 049</p>
        </div>
        <div>
          <p className="text-xs ml-2 mt-1"> 1st (approx)= </p>
          <p className="text-sky-700 font-semibold text-xs mr-2 ml-2 mt-1">
            {" "}
            $25.11{" "}
          </p>
        </div>
        ...
        <p className=" flex justify-center text-xs font-semibold mb-2">
          {" "}
          KYC: In review C{" "}
        </p>
      </div>
